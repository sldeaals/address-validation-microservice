...
import { validateCountry, cityExistsForCountry, postalCodeExistsForDistrict, stateExistsForCountry } from '../services';
...
export async function validateAddressController(
  ...
  try {
    ...
    const isValidPostalCode = postalCodeExistsForDistrict(country, city, postalCode);
